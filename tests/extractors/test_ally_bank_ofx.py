        ...
        (
            ...
            [
                    ...
                    Transaction(
                        ...
                        file="ally_bank.qfx",
                        lineno=2,
                        transaction_id="12345678901925",
                        date=datetime.date(2025, 8, 11),
                        post_date=datetime.date(2025, 8, 11),
                        desc="Requested transfer from TEST USER Ally Bank Transfer",
